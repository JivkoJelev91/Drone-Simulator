...
import {CommandState, commands} from '../ContextApi/StateContext.js';
...
class Buttons extends Component{
  ...
  render(){
    ...
    <CommandState.Provider value={this.state}>
...
export const CommandConsumer  = CommandState.Consumer;